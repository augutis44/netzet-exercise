...
const CardTitle = () => {
    return (
        <div className='flex flex-col items-center gap-[28px] px-[18.5px] pt-[27px] pb-[28px] lg:p-0'>
            <p className='text-[#68C7CD] font-[800] text-[25px] md:text-[30px] leading-[29.35px] md:leading-[20px] uppercase text-center'>
                Only you, only now
            </p>
            <Image src="/Flower.svg" alt="Flower Icon" width={47} height={43} />
            <p className='text-[20px] md:text-[27px] font-[600] leading-[24.58px] md:leading-[33.18px] text-center'>
