...
const Card = () => {
    return (
        <div className='bg-[#FFF8EA] px-[37px] py-[27px] w-full max-w-[867px] m-auto mt-[51px] mb-[106px] shadow-custom rounded-[10px] flex flex-col items-center gap-[28px]'>
            <p className='text-[#68C7CD] font-[800] text-[30px] leading-[20px] uppercase'>
                Only you, only now
            </p>
            <Image src="/Flower.svg" alt="Flower Icon" width={47} height={43} />
            <p className='text-[27px] font-[600] leading-[33.18px] text-center'>
            ...
            <div className='bg-[#FFFCF5] rounded-[10px] flex gap-[17px] items-center justify-center p-[16px]'>
